...
- **Finding models for analysis**: browse the [Models](/models/) and
  [Publications](/publications/) pages, or filter the loaded `model_tbl` in R
  by publication, model type, country, or region.
- **Contributing models**: read the
  [Contributing Models guide](/guides/contributing/) and the
